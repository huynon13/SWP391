...
<html lang="en" dir="ltr">
    <!-- Mirrored from maraviyainfotech.com/projects/ekka/ekka-v37/ekka-admin/product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Mar 2024 22:07:40 GMT -->
    <head>
        <meta charset="utf-8" />
                                                    ...
                                                    <div class="row product-overview">
                                                        <div class="col-12">
                                                            ...
                                                            <p class="product-desc">
                                                                ...
                                                                and typesetting industry. Lorem Ipsum has been the
                                                                industry's standard dummy text ever since the
                                                                1990. Lorem Ipsum is simply dummy text of the
                                                            ...
                                                            <div class="ec-ofr">
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        <b>Special Price :</b> Get extra 16% off
                                                                        (price inclusive of discount)
                                                                        <a href="#">T&C</a>
                                                                    </li>
                                                                    <li>
                                                                        <b>Bank Offer :</b> 10% off on XYZ Bank Cards,
                                                                        up to $12. On orders of $200 and above
                                                                        <a href="#">T&C</a>
                                                                    </li>
                                                                    <li>
                                                                        <b>Bank Offer :</b> 5% Unlimited Cashback on
                                                                        Ekka XYZ Bank Credit Card <a href="#">T&C</a>
                                                                    </li>
                                                                    <li>
                                                                        <b>Bank Offer :</b> Flat $50 off on first Ekka
                                                            ...
                                                            <ul class="product-color">
                                                                <li class="color">
                                                                    <span style="background-color: #90cdf7"></span>
                                                                </li>
                                                                <li class="color">
                                                                    <span style="background-color: #ff3b66"></span>
                                                                </li>
                                                                <li class="color">
                                                                    <span style="background-color: #ffc476"></span>
                                                                </li>
                                                                <li class="color">
                                                                    <span style="background-color: #1af0ba"></span>
                                                                </li>
                                                                <li class="color">
                                                                    <span style="background-color: #f887d6"></span>
                                                                </li>
                                                            </ul>
